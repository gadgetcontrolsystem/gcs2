...
import kz.gcs.maps.client.drawing.OverlayType;
import kz.gcs.maps.client.maptypes.GoogleImageMapType;
import kz.gcs.maps.client.services.*;
...
public class GoogleMapAdapterUtils {
    ...
    public static com.google.gwt.maps.client.drawinglib.DrawingManagerOptions toDrawingManagerOptions(DrawingOptions drawingOptions) {
        kz.gcs.maps.client.drawing.DrawingControlOptions
    ...
    public static PolygonOptions toPolygonOptions(kz.gcs.maps.client.drawing.PolygonOptions vOptions) {
    ...
    public static CircleOptions toCircleOptions(kz.gcs.maps.client.drawing.CircleOptions vOptions) {
    ...
    public static com.google.gwt.maps.client.drawinglib.OverlayType toOverlayType(
            kz.gcs.maps.client.drawing.OverlayType vOverlayType) {
    ...
    public static ControlPosition toControlPosition(
            kz.gcs.maps.client.drawing.ControlPosition vPosition) {
        if (vPosition == null) {
            return null;
        }
    ...
    public static ImageMapType toImageMapType(final GoogleImageMapType googleImageMapType) {
        ...
        if (googleImageMapType.getTileSize() != null) {
            kz.gcs.maps.client.base.Size googleSize = googleImageMapType.getTileSize();
